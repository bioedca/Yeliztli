/** Pathway detail slide-in panel for Traits & Personality (P3-64).
 *
 * Shows per-SNP breakdown for a selected traits pathway with genotypes,
 * trait domains, effect summaries, cross-module links, coverage notes,
    ...
    <div className="rounded-lg border bg-card p-4">
      ...
      {snp.trait_domain && (
        <p className="text-xs text-muted-foreground mb-1">
          Domain: <span className="font-medium">{snp.trait_domain}</span>
        </p>
      )}
