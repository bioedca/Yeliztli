...
export default function PathwayCard({
  ...
  // The "nothing interpreted → Not Assessed" rule lives in the shared helper so
  // this card, the fitness card, and the backend report/SVG paths cannot label
  // the same result differently (#2178).
