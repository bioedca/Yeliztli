/** Pathway detail slide-in panel for Gene Sleep (P3-50).
 *
 * Shows per-SNP breakdown for a selected sleep pathway with genotypes,
 * effect summaries, recommendations, CYP1A2 metabolizer state labels,
...
import type { SNPDetail } from "@/types/sleep"
...
function SNPRow({ snp }: { snp: SNPDetail }) {
  ...
  return (
    <div className="rounded-lg border bg-card p-4">
      ...
      {/* Coverage note (HLA proxy / PER3 VNTR) */}
      {snp.coverage_note && (
