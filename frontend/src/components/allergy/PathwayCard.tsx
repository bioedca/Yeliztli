/** Pathway card for Gene Allergy module (P3-61).
 *
 * Displays a single allergy pathway with its categorical level
...
const PATHWAY_DESCRIPTIONS: Record<string, string> = {
  atopic_conditions:
    "Genetic predisposition to atopic conditions including asthma, eczema, and allergic rhinitis.",
