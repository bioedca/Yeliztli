/** Pathway card for Gene Skin module (P3-56).
 *
 * Displays a single skin pathway with its categorical level
...
const PATHWAY_DESCRIPTIONS: Record<string, string> = {
  pigmentation_uv:
    "MC1R-driven pigmentation, UV sensitivity, and sun response traits.",
  skin_barrier_inflammation:
    "Skin barrier integrity, filaggrin status, and inflammatory predisposition.",
  oxidative_stress_aging:
    "Antioxidant capacity, collagen maintenance, and oxidative stress resilience.",
  skin_micronutrients:
    "Vitamin D receptor variants affecting skin health and micronutrient utilization.",
}
