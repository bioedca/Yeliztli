...
| Context7 | Five EBI Nightingale library-resolution attempts | Returned only an unrelated `/ccfos/nightingale` package. No Context7 documentation was used; the pinned official upstream source was inspected instead. |
| Nightingale upstream | [`config.ts`](https://github.com/ebi-webcomponents/nightingale/blob/a4a65eccbf03fe5290adb1ec171cb5a43e8a3d83/packages/nightingale-track/src/config.ts#L69-L75), [`FeatureShape.ts`](https://github.com/ebi-webcomponents/nightingale/blob/a4a65eccbf03fe5290adb1ec171cb5a43e8a3d83/packages/nightingale-track/src/FeatureShape.ts#L101-L135), and [`nightingale-track README`](https://github.com/ebi-webcomponents/nightingale/blob/a4a65eccbf03fe5290adb1ec171cb5a43e8a3d83/packages/nightingale-track/README.md#L18-L35) | `DISULFID` maps to `bridge`; `bridge` is non-continuous, and `non-overlapping` layout uses separate vertical positions for overlapping features. |
