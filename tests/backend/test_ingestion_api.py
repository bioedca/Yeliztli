...
class TestIngestEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_ingest_concatenated_vendor_file_returns_actionable_422(self, monkeypatch):
        concatenated = (
            b"# This data file generated by 23andMe\n"
            b"# reference human assembly build 37\n"
            b"# rsid\tchromosome\tposition\tgenotype\n"
        ...
        class _Registry:
            settings = Settings(data_dir=Path("/tmp/yeliztli-route-test"), wal_mode=False)

        monkeypatch.setattr(ingest_route, "get_registry", lambda: _Registry())
