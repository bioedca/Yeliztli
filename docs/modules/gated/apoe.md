...
!!! info "This is an opt-in module"
    *APOE* results — especially the ε4 status linked to Alzheimer's risk — stay **hidden until
    you explicitly acknowledge** that you want to see them. Until then the result is computed
    but locked. You're in control of when (or whether) to reveal it.

*APOE* is one of the most studied genes in human health. Yeliztli determines your *APOE*
**diplotype** (the ε2/ε3/ε4 combination) from two SNPs, rs429358 and rs7412.

## What you'll see

Your diplotype (e.g. ε3/ε4) and three findings:
