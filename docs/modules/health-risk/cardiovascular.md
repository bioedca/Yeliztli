...
- **Familial hypercholesterolemia (FH):** *LDLR*, *PCSK9*, and FH-causing *APOB*
  variants
- **Other lipid metabolism:** *LPA*, *ABCG5*, *ABCG8*, and protein-truncating *APOB*
  variants linked to familial hypobetalipoproteinemia (low LDL cholesterol)
...
- **APOB is bidirectional.** Protein-truncating *APOB* variants linked to familial
  ...
  status. Other *APOB* findings follow the module's existing FH criteria, including its
  ClinVar condition-label and lower-penetrance/risk-allele filters. This distinction is
