...
) -> tuple[dict[str, str], dict[str, tuple[str, int, str, str]]]:
    ...
    for rsid in rsids:
        ...
        if chrom is not None and pos is not None and ref and alt:
            try:
                ...
                pass
    return genotype_by_rsid, allele_by_rsid
...
def _lookup_vep(
    ...
    genotype_by_rsid, allele_by_rsid = _vep_sample_context(rsids, raw_by_rsid)
...
def _annot_to_dict(annot: GnomADAnnotation) -> dict:
    ...
    return {
        ...
        "gnomad_af_asj": annot.af_asj,
        "gnomad_af_eas": annot.af_eas,
        "gnomad_af_eur": annot.af_eur,
        "gnomad_af_fin": annot.af_fin,
        "gnomad_af_sas": annot.af_sas,
        "gnomad_an_global": annot.an_global,
        "gnomad_an_afr": annot.an_afr,
        "gnomad_an_amr": annot.an_amr,
        "gnomad_an_asj": annot.an_asj,
        "gnomad_an_eas": annot.an_eas,
        "gnomad_an_eur": annot.an_eur,
...
def _vep_coord_fallback(
    ...
    genotype_by_rsid, allele_by_rsid = _vep_sample_context(unmatched_rsids, raw_by_rsid)
