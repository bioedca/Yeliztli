...
annotated_variants = sa.Table(
    ...
    sa.Column("gnomad_an_global", sa.Integer),
    sa.Column("gnomad_an_afr", sa.Integer),
    sa.Column("gnomad_an_amr", sa.Integer),
    sa.Column("gnomad_an_asj", sa.Integer),
    sa.Column("gnomad_an_eas", sa.Integer),
    sa.Column("gnomad_an_eur", sa.Integer),
    sa.Column("gnomad_an_fin", sa.Integer),
    sa.Column("gnomad_an_sas", sa.Integer),
    sa.Column(
        "gnomad_source_status",
        sa.Text,
        comment=(
            "observed | source_uncovered | allele_ambiguous; "
    ...
    sa.Column(
        "gnomad_an_popmax",
        sa.Integer,
        comment="Observed allele count paired with gnomAD popmax AF",
    ),
