...
Honesty / ethics guardrails (§12.6, §12.10):
  - **Reduced, age-dependent penetrance** — published age-80 estimates vary by
    cohort design, ancestry, and modifier burden: recent cohorts report roughly
    24-49%, with kin-cohort estimates around 25-42.5%. By age 80, most carriers
    in these cohorts had not developed Parkinson's disease. A positive call is
    never a diagnosis or a prediction.
