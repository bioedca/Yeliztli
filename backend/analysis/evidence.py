...
def assign_clinvar_evidence_level(
    ...
    *,
    ...
    Args:
        ...
        ensemble_pathogenic: Whether the dbNSFP ensemble rule flagged a strict
            majority of assessed independent in-silico axes as deleterious.
            Tracked for downstream reporting; this function does not currently
            promote evidence level based on this flag.
